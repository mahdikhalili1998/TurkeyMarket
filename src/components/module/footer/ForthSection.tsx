...
function ForthSection() {
  return (
    <div>
      <div className="mt-5 hidden items-center justify-between bg-field3 px-16 py-3 xl:flex">
      ...
      {/* شبکه اجتماعی */}
      <div className="mx-4 mt-3 flex items-center justify-between gap-3 rounded-md bg-field6 p-2 px-3 text-text-color">
