...
function FirstSection() {
  return (
    <div>
      {/* مستطیل اول */}
      <div className="dark:bg-dark-bg2 h-[5rem] w-full bg-field6 pt-8 xl:h-[8rem] xl:px-4">
        ...
        <div className="mx-2 mt-5 flex items-center justify-around rounded-lg bg-main-orange py-3 xl:mx-12 xl:mt-10 xl:justify-between xl:px-12 xl:py-4">
          <h3 className="hidden font-semibold text-white xl:block xl:text-lg">
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 rounded-lg bg-field6 px-3 py-2 text-sm text-black dark:bg-main-dark dark:text-white xl:p-[10px] xl:py-3">
